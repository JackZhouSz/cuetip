...
class LanguageAgent(Agent):
    def __init__(self, target_balls):
        ...
        self.chooser = LM_Chooser(target_balls)
        self.SEARCH_STEPS = 100
        self.N = 5
        self.record = {}
        self.agent_name = "LanguageAgent"
    ...
    def take_shot(self, env, state, lm, message=None, logger=None, parallel=True) -> dict:
        ...
        try:
            chosen_shot = self.chooser(shot_events=simulated_shot_events, lm=lm, logger=logger)
        except:
